...
public class Account extends AggregateRoot{
    ...
    public static Account open(UserId userId, AccountType type) {
        AccountNumber generatedNumber = AccountNumber.generate();
    ...
    public static Account withId(AccountId id, UserId userId, AccountNumber number, AccountType type,
                                 Money balance, AccountStatus status, Integer version,
